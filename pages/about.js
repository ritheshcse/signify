  ...
  return (
    <div style={{ marginTop: '2em' }}>
      <div className="jumbotron text-center">
        <h1>Signify - ASL Translator</h1><br/>
        <h4>
      ...
      <div className="bg-secondary jumbotron">
        <h3 className="text-center" style={{paddingTop: "10px"}}>1. OpenCV Pipeline</h3><br/>
      ...
      <br/>
      <div className="bg-secondary jumbotron">
        <h3 className="text-center" style={{paddingTop: "10px"}}>2. Tensorflow CNN</h3><br/>
        <div className="row justify-content-center">
          <img
      ...
      <br/>
      <div className="bg-secondary jumbotron">
        <h3 className="text-center" style={{paddingTop: "10px"}}>3. Interpreting The Results</h3><br/>
        <div className="row justify-content-center">
          <img
      ...
      <br/>
      <div className="bg-secondary jumbotron">
        <h3 className="text-center" style={{paddingTop: "10px"}}>4. Autocorrection And Text To Speech</h3><br/>
        <div className="row justify-content-center">
          <img
            src="tts.jpeg"
            alt="OpenCV Pipeline Demo"
